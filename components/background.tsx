...
const Dot = () => {
  return (
    <div className="h-6 w-6 bg-white dark:bg-neutral-900 flex items-center justify-center rounded-full">
      <div className="h-2 w-2 bg-[#5A73A3]/20 dark:bg-[#5A73A3]/20 rounded-full" />
    </div>
  );
};
...
const SVGVertical = ({ className }: { className?: string }) => {
  ...
  return (
    <motion.svg
      ...
      className={cn("text-[#5A73A3]/10 dark:text-[#5A73A3]/10", className)}
    >
      ...
      <defs>
        ...
        >
          ...
          <motion.stop offset="50%" stopColor="#5A73A3" />
