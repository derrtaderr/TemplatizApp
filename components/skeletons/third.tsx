    ...
    <div className="h-full w-full sm:w-[80%] mx-auto bg-white dark:bg-neutral-800  shadow-2xl dark:shadow-white/40 mt-10 group rounded-md">
      ...
      <div className="flex flex-1 w-full h-full flex-col space-y-2 ">
        ...
        <div className="flex flex-col space-y-4 p-4">
          <Row title="Knowledge " updatedAt="23rd March" />
          <Row title="Growth" updatedAt="21st March" active />
          <Row title="Authority" updatedAt="3rd May" />
          <Row title="Custom " updatedAt="1st April" active />
