...
export const blog = {
  ...
  description:
    "Learn how templatizing content, discovering top-performing posts, and automating scheduling can help creators save time, stay consistent, and grow their audience.",
